...
import { register, login, logout, refresh, completeProfile, updateUser } from './authOperations'
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) =>
    builder
      ...
      .addMatcher(isAnyOf(register.fulfilled, login.fulfilled), authFulfilledReducer)
