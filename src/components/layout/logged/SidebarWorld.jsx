...
const SidebarWorld = () => {
  ...
  return (
    ...
    <SidebarItem title="Departments" icon={<FaRegBuilding />}>
      <NavLink to="/world/web-development-department">
        <Button className="sidebar-button">
          <div className="sidebar-list">
            <MdDeveloperMode />
      ...
      <NavLink to="/world/administration">
        <Button className="sidebar-button">
          <div className="sidebar-list">
            <RiAdminLine />
      ...
      <NavLink to="/world/training-center">
        <Button className="sidebar-button">
          <div className="sidebar-list">
          <TbDeviceImacSearch />
      ...
      <NavLink to="/world/conference-rooms">
        <Button className="sidebar-button">
          <div className="sidebar-list">
            <MdMeetingRoom />
