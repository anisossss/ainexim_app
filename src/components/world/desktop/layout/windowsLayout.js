...
import { IoLogoApple, IoIosWifi, IoIosBluetooth, IoIosSwitch } from 'react-icons/io'
...
const WindowsLayout = ({ classes, userName, selectOS }) => {
  ...
  const dockItems = [
    { label: 'File Explorer', icon: '/img/svg/files.svg', command: () => handleDockItemClick(0) },
    { label: 'Chrome', icon: '/img/svg/google.png', command: () => handleDockItemClick(1) },
    {
      label: 'Terminal',
      icon: '/img/svg/terminal_windows.png',
      command: () => handleDockItemClick(2),
    },
    { label: 'VS Code', icon: '/img/svg/vscode.png', command: () => handleDockItemClick(3) },
    { label: 'GitHub', icon: '/img/svg/github.svg', command: () => handleDockItemClick(4) },
    { label: 'Bin', icon: '/img/svg/bin_windows.png', command: () => handleDockItemClick(5) },
  ]
