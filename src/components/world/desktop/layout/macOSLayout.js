...
const MacOSLayout = ({ classes, userName, formattedTime, selectOS }) => {
  ...
  const dockItems = [
    { label: 'Finder', icon: '/img/svg/finder.svg', command: () => handleDockItemClick(0) },
    { label: 'Terminal', icon: '/img/svg/terminal.svg', command: () => handleDockItemClick(1) },
    { label: 'VS Code', icon: '/img/svg/vscode.png', command: () => handleDockItemClick(2) },
    { label: 'App Store', icon: '/img/svg/appstore.svg', command: () => handleDockItemClick(3) },
    { label: 'Safari', icon: '/img/svg/safari.svg', command: () => handleDockItemClick(4) },
    { label: 'GitHub', icon: '/img/svg/github.svg', command: () => handleDockItemClick(5) },
    { label: 'Trash', icon: '/img/svg/trash.png', command: () => handleDockItemClick(6) },
  ]
