...
const MeetingRoom = (props) => {
  ...
  const joinRoom = () => {
    ...
    socket.emit('joined', { userName: user.name, userId: user._id, roomId: roomId })
  }
  ...
  return (
    <Frame animate={true} className={classes.frame}>
      {step === 1 && (
        <div id="welcome-container" style={{ padding: '2em', height: '59.6dvh' }}>
          <div style={{ height: '80%' }}>
            <p>
              Welcome <span style={{ color: '#23CAEA' }}>{name}</span>! Check your last task for
              room ID
            </p>
            <span style={{ marginTop: '1em', lineHeight: '2em', fontSize: '14px' }}>
              Before joining the meeting, please ensure you understand the task at hand and the
              objective of your contributions:
              <br />
              - This meeting is designed for task collaboration and contribution.
              <br />
              - Your active participation and input during the meeting are crucial for achieving the
              task objectives.
              <br />- Upon exiting the meeting, your contributions will be evaluated in relation to
              the task's goals and requirements.
            </span>
          </div>
